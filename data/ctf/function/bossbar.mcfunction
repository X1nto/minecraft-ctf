...
execute if score tick tick matches 20 run function datapack:addrem/add1rem20
execute if score sec tick matches -1 run function datapack:addrem/add1rem60
...
execute if entity @e[tag=started,name=start] if score min tick matches 0 if score sec tick matches 0 run function datapack:gameend
...
execute at @e[type=item_display,tag=blueflag] if entity @a[distance=..1,team=Red,gamemode=adventure] run function ctf:flag/taken {owner:Blue, thief:Red}
execute at @e[type=item_display,tag=redflag] if entity @a[distance=..1,team=Blue,gamemode=adventure] run function ctf:flag/taken {owner:Red, thief:Blue}
